...
public class TaquinApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        TaquinController fxmlController = fxmlLoader.getController();
        Taquin taquin = new Taquin(4);
        taquin.setController(fxmlController);
        fxmlController.setModel(taquin);
        fxmlController.setScene(scene);
        taquin.startGame();
